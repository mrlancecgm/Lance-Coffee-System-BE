using LanceCoffeeSystem.Api.Services;
using LanceCoffeeSystem.Application.DTOs.Settings;
using LanceCoffeeSystem.Application.Interfaces;
...
using LanceCoffeeSystem.Infrastructure.Identity.Services;
using LanceCoffeeSystem.Infrastructure.Shared.Services;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\LanceCoffeeSystem.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    Version = "v1",
                    Title = "LanceCoffeeSystem",
