using LanceCoffeeSystem.Application.DTOs;
using LanceCoffeeSystem.Application.Features.ActivityLog.Queries.GetUserLogs;
...
namespace LanceCoffeeSystem.Web.Areas.Identity.Pages.Account
{
